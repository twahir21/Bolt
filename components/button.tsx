...
const getTextVariantStyle = (variant: ButtonProps['textVariant']) => {
    switch(variant) {
     ...
     default: return "text-white"; // this is primary button
    }
}


const Button = ({ onPress, title, bgVariant="primary", textVariant = "default",
    IconLeft, IconRight, className, ...props
 }: ButtonProps) => (
    <TouchableOpacity onPress={onPress} 
      className={`p-3 rounded-full flex flex-row justify-center items-center shadow-md
