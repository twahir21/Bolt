import { InputFieldProps } from "@/types/declare";
...
const InputField = ({
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? "padding" : "height"}>
            {/* For closing keyboard on outside touch  */}
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View className="my-2 w-full">
                    ...
                    <View className={`flex flex-row justify-start items-center relative 
                        bg-neutral-100 rounded-full border border-neutral-200 focus:border-primary-500 
                        ${containerStyle}`}>
